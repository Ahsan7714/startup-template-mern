...
const Popup = ({ onClose }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
      ...
      <div className="px-6 py-16 lg:w-[43%] md:w-[50%]  w-[98%]   bg-[#ebebeb]  lg:h-[70vh] rounded-md  absolute flex flex-col gap-6 justify-center items-center">
      <IoClose className="absolute top-[10px] right-1 lg:right-5 text-[34px] text-[#3f691f] cursor-pointer"  onClick={onClose}/>
        ...
        <form onSubmit={handleSubscribe} className="flex flex-col gap-8">
          ...
          className="text-[14px]  border-[1px] border-[#BDBDBD] px-4 py-3 w-[300px] lg:w-[400px] sm:w-[500px] rounded-[4px] outline-none text-[#4F4F4F] placeholder-[#4F4F4F]"

          />
        <button className="bg-[#3f691f] text-white py-3  px-3 font-semibold rounded-lg  lg:w-[400px] border hover:border-[#3f691f] hover:bg-white hover:text-[#3f691f] duration-300 "

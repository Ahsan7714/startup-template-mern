...
const MobileApp = () => {
  return (
    <div className='mb-[220%] lg:mb-[30%]'>
        <img src={bgy} alt="" className='h-[200vh] w-[30%] relative'/>
        <div className='flex'>
            <div>
                <img src={mobile} alt="" className='absolute lg:top-20 lg:left-40 left-10 top-10'/>
            </div>
            <div className='absolute top-[75%] left-[10%] lg:top-[25%] lg:left-[50%] flex flex-col '>
        ...
        <div className='absolute lg:top-[45rem] top-[65rem] left-[10%] w-[90%] '>
            ...
            <div className='bg-[#87a972] w-full h-fit lg:h-[105vh] text-white flex flex-col gap-[4rem] lg:gap-[4rem] py-[6%] lg:py-0  lg:pt-[5%] rounded-s-[10px] '>
                <div className='flex lg:flex-row flex-col justify-center gap-[4rem] lg:gap-[7rem]  items-center'>

...
<Link to={"/menu"} className="view_menu_btn">View Menu</Link>
    ...
    <div className="content  flex-col gap-7 px-10 lg:px-0 ">
      <h1>R&B USA Mobile App</h1>
      <p className="w-96 px-10 lg:px-0">We are proud to announce the launch of our new Mobile App coming soon. It’s a convenient way to order ahead and pay right on your phone. Download today on Apple App Store and Google Play Store!</p>
    </div>
    </div>
    </div>
